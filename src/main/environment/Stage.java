...
public class Stage {
    ...
    private void buildTesseractStage() {
        ...
        nodes = plane.buildPanel(_myMain.udpModel.rabbits[0], counter,-(72*9),startY,0, 0, 0,0,0,false );

        Node[] planeNodes = plane.buildPanel(_myMain.udpModel.rabbits[1], counter,-(72*6),startY,0, 0, 0,0,0,true );
        nodes = (Node[]) _myMain.concat( nodes, planeNodes );

        planeNodes = plane.buildPanel(_myMain.udpModel.rabbits[2], counter,-(72*3),startY,0, 0,0,0,0, false );
        nodes = (Node[]) _myMain.concat( nodes, planeNodes );

        planeNodes = plane.buildPanel(_myMain.udpModel.rabbits[3], counter,0,startY,0, 0,0,0,0, false  );
        nodes = (Node[]) _myMain.concat( nodes, planeNodes );

        planeNodes = plane.buildPanel(_myMain.udpModel.rabbits[4], counter,(72*3),startY,0, 0, 0,0,0,false );
        nodes = (Node[]) _myMain.concat( nodes, planeNodes );

        planeNodes = plane.buildPanel(_myMain.udpModel.rabbits[5], counter,(72*6),startY,0, 0, 0,0,0,false );
        nodes = (Node[]) _myMain.concat( nodes, planeNodes );
