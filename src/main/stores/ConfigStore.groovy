...
class ConfigStore extends BaseStore {
  ...
  private Map<String, Object> configOptions = [
      ...
      stageType       : [
          ...
          transformValueFn : { it.toUpperCase() },
          validateFn       : { ['CUBOTRON', 'TESSERACT', 'TESSERACT_WALL', 'DRACO', 'SCARED'].contains(it) },
          validateFailMsgFn: { "stageType '${it}' is invalid.  Must be one of 'CUBOTRON', 'TESSERACT', 'TESSERACT_WALL', 'DRACO', or 'SCARED'" },
      ],
