...
public class TesseractMain extends PApplet {
    ...
    public static final int SPINFADE = 8;
    ...
    public Integer mapController = 1;
    public Integer mapPort = 1;
...
//    PlaylistStore.get().saveDataToDisk();
    ...
    public int[] renderNode(Node node) {
        ...
        rgb1[1] = (int) Math.round(rgb1[1] * 0.6);
        rgb1[2] = (int) Math.round(rgb1[2] * 0.5);
